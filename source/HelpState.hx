...
class HelpState extends FlxState 
{
	...
	private function clickUp():Void
	{
		...
		FlxTween.tween(story, {y:newDest}, .33, {type:FlxTweenType.ONESHOT, ease:FlxEase.sineInOut, onComplete:function(_){
			scrolling = false;
		}});
	...
	{
		FlxTween.tween(attackMonster, {x:108}, .5, {type:FlxTweenType.ONESHOT, ease:FlxEase.backIn, startDelay:.5, onComplete:function(_){
			...
			FlxTween.tween(attackMonster, {x:104}, .5, {type:FlxTweenType.ONESHOT, ease:FlxEase.backOut, onComplete:function(_){
				doMonsterTween();
			}});
		}});
	}
	...
	{
		FlxTween.tween(attackHero, {x:112}, .5, {type:FlxTweenType.ONESHOT, ease:FlxEase.backIn, startDelay:.5, onComplete:function(_){
			switch (FlxG.random.int(0, 3))
			{
				case 0:
			...
			FlxTween.tween(attackHero, {x:116}, .5, {type:FlxTweenType.ONESHOT, ease:FlxEase.backOut, onComplete:function(_){
				doHeroTween();
			}});
		}});
	}
